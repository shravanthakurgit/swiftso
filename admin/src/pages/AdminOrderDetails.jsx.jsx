...
const OrderDetails = ({token}) => {
  ...
  const fetchOrders = async () => {
    try {
        console.log(orderId)
      const response = await axios.post(`${backendUrl}/api/order/admin-order-details`,{orderId},{
      headers: {
        ...
        <div key={index} className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-6 border-b border-gray-100">
            <div className="flex justify-between items-center">
              <h2 className="text-sm font-semibold text-gray-800">ORDER ID: {item.orderId}</h2>
