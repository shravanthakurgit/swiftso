...
const finalComment = comment || ratings.find((item) => item.r === rating)?.label || "";
...
useEffect(() => {
  ...
  return (
    <div className="w-[100%] max-w-[500px] mx-auto mt-6">
      ...
      {message && (
       ...
       {showForm && (
        ...
        >
          <div>
            <label className="block mb-1 font-medium monst">Rate This Product</label>
  ...
  {ratings.map(({ r, label }) => (
    ...
    >
      ...
      {label}
          ...
          <div>
            <label className="block mb-2 font-medium monst text-left ml-1 mt-6 ">Comment:</label>
            <textarea
              value={comment}
