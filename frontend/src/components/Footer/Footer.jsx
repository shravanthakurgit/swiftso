...
const Footer = () => {
  return (
    ...
    <footer className="bg-white dark:bg-gray-900 w-full">
        ...
        <div className="px-4 py-6 bg-black dark:bg-gray-900 md:flex md:items-center md:justify-between w-full text-white px-8">
            <span className="text-sm sm:text-center">© 2023 <a href="https://flowbite.com/">SwiftSo™</a>. All Rights Reserved.
            </span>
